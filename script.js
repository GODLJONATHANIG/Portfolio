...
function sendEmail() {
    ...
    const mailtoLink = `mailto:swastikkulkarni737@gmail.com?subject=${subject}&body=First Name: ${firstName}%0D%0ALast Name: ${lastName}%0D%0AEmail: ${email}%0D%0A%0D%0AMessage:%0D%0A${message}`;
